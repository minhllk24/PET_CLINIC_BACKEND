...
var _orderAPIService = _interopRequireDefault(require("../services/orderAPIService"));
...
var handleGetOrders = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return _orderAPIService["default"].getOrders(req.user, req.query);
        case 1:
          data = _context.v;
  ...
  return function handleGetOrders(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var handleGetDetailOrder = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          ...
          id = req.params.id;
          _context2.n = 1;
          return _orderAPIService["default"].getOrderById(id, req.user);
        case 1:
          data = _context2.v;
  ...
  return function handleGetDetailOrder(_x3, _x4) {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          ...
          _context3.n = 1;
          return _orderAPIService["default"].checkoutCart(userId, req.body);
        case 1:
          data = _context3.v;
...
var handleUpdateOrderStatus = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        case 0:
          ...
          _context4.n = 1;
          return _orderAPIService["default"].updateOrderStatus(id, status);
        case 1:
          data = _context4.v;
  ...
  return function handleUpdateOrderStatus(_x7, _x8) {
