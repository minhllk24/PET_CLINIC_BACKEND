...
var _healthDiaryAPIService = _interopRequireDefault(require("../services/healthDiaryAPIService"));
...
var handleGetDiaries = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          _context.n = 1;
          return _healthDiaryAPIService["default"].getDiariesByPet(petId, req.query, req.user);
        case 1:
          data = _context.v;
  ...
  return function handleGetDiaries(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var handleCreateDiary = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          _context2.p = 0;
          _context2.n = 1;
          return _healthDiaryAPIService["default"].createDiary(req.body, req.user);
        case 1:
          data = _context2.v;
  ...
  return function handleCreateDiary(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var handleGetReminders = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          ...
          petId = req.params.petId;
          _context3.n = 1;
          return _healthDiaryAPIService["default"].getRemindersByPet(petId, req.user);
        case 1:
          data = _context3.v;
  ...
  return function handleGetReminders(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var handleCreateReminder = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        case 0:
          _context4.p = 0;
          _context4.n = 1;
          return _healthDiaryAPIService["default"].createReminder(req.body, req.user);
        case 1:
          data = _context4.v;
  ...
  return function handleCreateReminder(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var handleCompleteReminder = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.p = _context5.n) {
        case 0:
          ...
          id = req.params.id;
          _context5.n = 1;
          return _healthDiaryAPIService["default"].completeReminder(id, req.user);
        case 1:
          data = _context5.v;
  ...
  return function handleCompleteReminder(_x9, _x0) {
    return _ref5.apply(this, arguments);
  };
}();
var handleDeleteReminder = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context6) {
      while (1) switch (_context6.p = _context6.n) {
        case 0:
          ...
          id = req.params.id;
          _context6.n = 1;
          return _healthDiaryAPIService["default"].deleteReminder(id, req.user);
        case 1:
          data = _context6.v;
  ...
  return function handleDeleteReminder(_x1, _x10) {
    return _ref6.apply(this, arguments);
  };
}();
module.exports = {
  handleGetDiaries: handleGetDiaries,
  handleCreateDiary: handleCreateDiary,
  handleGetReminders: handleGetReminders,
