...
var _loyaltyAPIService = _interopRequireDefault(require("../services/loyaltyAPIService"));
...
var handleGetVouchers = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return _loyaltyAPIService["default"].getAllVouchers();
        case 1:
          data = _context.v;
  ...
  return function handleGetVouchers(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var handleCreateVoucher = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          _context2.p = 0;
          _context2.n = 1;
          return _loyaltyAPIService["default"].createVoucher(req.body);
        case 1:
          data = _context2.v;
  ...
  return function handleCreateVoucher(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var handleApplyVoucher = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          ...
          _context3.n = 1;
          return _loyaltyAPIService["default"].applyVoucher(userId, req.body);
        case 1:
          data = _context3.v;
  ...
  return function handleApplyVoucher(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var handleGetMyPoints = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        case 0:
          ...
          userId = req.user.user_id;
          _context4.n = 1;
          return _loyaltyAPIService["default"].getMyPoints(userId);
        case 1:
          data = _context4.v;
  ...
  return function handleGetMyPoints(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var handleGetMyTransactions = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.p = _context5.n) {
        case 0:
          ...
          userId = req.user.user_id;
          _context5.n = 1;
          return _loyaltyAPIService["default"].getMyTransactions(userId);
        case 1:
          data = _context5.v;
  ...
  return function handleGetMyTransactions(_x9, _x0) {
    return _ref5.apply(this, arguments);
  };
}();
module.exports = {
  handleGetVouchers: handleGetVouchers,
  handleCreateVoucher: handleCreateVoucher,
  handleApplyVoucher: handleApplyVoucher,
  handleGetMyPoints: handleGetMyPoints,
  handleGetMyTransactions: handleGetMyTransactions
};