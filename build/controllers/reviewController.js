...
var _reviewAPIService = _interopRequireDefault(require("../services/reviewAPIService"));
...
var handleGetReviews = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
    var _req$params, targetType, targetId, data, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _req$params = req.params, targetType = _req$params.targetType, targetId = _req$params.targetId;
          _context.n = 1;
          return _reviewAPIService["default"].getReviewsByTarget(targetType, targetId, req.query);
        case 1:
          data = _context.v;
  ...
  return function handleGetReviews(_x, _x2) {
...
var handleCreateReview = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          ...
          _context2.n = 1;
          return _reviewAPIService["default"].createReview(userId, req.body);
        case 1:
          data = _context2.v;
  ...
  return function handleCreateReview(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var handleRejectReview = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          ...
          id = req.params.id;
          _context3.n = 1;
          return _reviewAPIService["default"].updateReviewStatus(id, 'rejected');
        case 1:
          data = _context3.v;
  ...
  return function handleRejectReview(_x5, _x6) {
...
var handleDeleteReview = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        case 0:
          ...
          id = req.params.id;
          _context4.n = 1;
          return _reviewAPIService["default"].updateReviewStatus(id, 'deleted');
        case 1:
          data = _context4.v;
  ...
  return function handleDeleteReview(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var handleGetAllReviews = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.p = _context5.n) {
        case 0:
          _context5.p = 0;
          _context5.n = 1;
          return _reviewAPIService["default"].getAllReviews(req.query);
        case 1:
          data = _context5.v;
  ...
  return function handleGetAllReviews(_x9, _x0) {
    return _ref5.apply(this, arguments);
  };
}();
var handleLikeReview = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(req, res) {
    var userId, reviewId, data, _t6;
    return _regenerator().w(function (_context6) {
      while (1) switch (_context6.p = _context6.n) {
        case 0:
          ...
          _context6.n = 1;
          return _reviewAPIService["default"].likeReview(userId, reviewId);
        case 1:
          data = _context6.v;
  ...
  return function handleLikeReview(_x1, _x10) {
    return _ref6.apply(this, arguments);
  };
}();
var handleReplyReview = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7(req, res) {
    var userId, parentId, data, _t7;
    return _regenerator().w(function (_context7) {
      while (1) switch (_context7.p = _context7.n) {
        case 0:
          ...
          _context7.n = 1;
          return _reviewAPIService["default"].replyReview(userId, parentId, req.body);
        case 1:
          data = _context7.v;
  ...
  return function handleReplyReview(_x11, _x12) {
