...
var _petAPIService = _interopRequireDefault(require("../services/petAPIService"));
...
var handleGetMyPets = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          _context.n = 1;
          return _petAPIService["default"].getMyPets(userId);
        case 1:
          data = _context.v;
  ...
  return function handleGetMyPets(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var handleGetDetailPet = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          ...
          id = req.params.id;
          _context2.n = 1;
          return _petAPIService["default"].getPetById(id, req.user);
        case 1:
          data = _context2.v;
  ...
  return function handleGetDetailPet(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var handleCreatePet = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          ...
          userId = req.user.user_id;
          _context3.n = 1;
          return _petAPIService["default"].createPet(userId, req.body);
        case 1:
          data = _context3.v;
  ...
  return function handleCreatePet(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var handleUpdatePet = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        case 0:
          ...
          id = req.params.id;
          _context4.n = 1;
          return _petAPIService["default"].updatePet(id, req.body, req.user);
        case 1:
          data = _context4.v;
  ...
  return function handleUpdatePet(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var handleDeletePet = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.p = _context5.n) {
        case 0:
          ...
          id = req.params.id;
          _context5.n = 1;
          return _petAPIService["default"].deletePet(id, req.user);
        case 1:
          data = _context5.v;
  ...
  return function handleDeletePet(_x9, _x0) {
    return _ref5.apply(this, arguments);
  };
}();
var handleGetSpecies = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context6) {
      while (1) switch (_context6.p = _context6.n) {
        case 0:
          _context6.p = 0;
          _context6.n = 1;
          return _petAPIService["default"].getSpecies();
        case 1:
          data = _context6.v;
  ...
  return function handleGetSpecies(_x1, _x10) {
    return _ref6.apply(this, arguments);
  };
}();
var handleGetBreeds = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7(req, res) {
    var speciesId, data, _t7;
    return _regenerator().w(function (_context7) {
      while (1) switch (_context7.p = _context7.n) {
        case 0:
          _context7.p = 0;
          speciesId = req.query.species_id;
          if (speciesId) {
            _context7.n = 1;
            break;
          }
          return _context7.a(2, (0, _responseHelpers.sendResponse)(res, 400, 'Missing species_id query param', 1));
        case 1:
          _context7.n = 2;
          return _petAPIService["default"].getBreedsBySpecies(speciesId);
        case 2:
          data = _context7.v;
  ...
  return function handleGetBreeds(_x11, _x12) {
    return _ref7.apply(this, arguments);
  };
}();
module.exports = {
  handleGetMyPets: handleGetMyPets,
  handleGetDetailPet: handleGetDetailPet,
  handleCreatePet: handleCreatePet,
  handleUpdatePet: handleUpdatePet,
  handleDeletePet: handleDeletePet,
  handleGetSpecies: handleGetSpecies,
  handleGetBreeds: handleGetBreeds
};