...
var handleGetAllUsers = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          _context.n = 1;
          return _userAPIService["default"].getAllUsers(limit, page);
        case 1:
          data = _context.v;
  ...
  return function handleGetAllUsers(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var handleGetDetailUser = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          ...
          id = req.params.id;
          _context2.n = 1;
          return _userAPIService["default"].getUserById(id);
        case 1:
          data = _context2.v;
  ...
  return function handleGetDetailUser(_x3, _x4) {
...
var handleUpdateUser = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          ...
          id = req.params.id;
          _context3.n = 1;
          return _userAPIService["default"].updateUser(id, req.body);
        case 1:
          data = _context3.v;
  ...
  return function handleUpdateUser(_x5, _x6) {
...
var handleDeleteUser = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        case 0:
          ...
          id = req.params.id;
          _context4.n = 1;
          return _userAPIService["default"].deleteUser(id);
        case 1:
          data = _context4.v;
  ...
  return function handleDeleteUser(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var handleGetUserAddresses = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.p = _context5.n) {
        case 0:
          ...
          id = req.params.id;
          _context5.n = 1;
          return _userAPIService["default"].getUserAddresses(id);
        case 1:
          data = _context5.v;
  ...
  return function handleGetUserAddresses(_x9, _x0) {
    return _ref5.apply(this, arguments);
  };
}();
var handleCreateAddress = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context6) {
      while (1) switch (_context6.p = _context6.n) {
        case 0:
          ...
          id = req.params.id;
          _context6.n = 1;
          return _userAPIService["default"].createAddress(id, req.body);
        case 1:
          data = _context6.v;
  ...
  return function handleCreateAddress(_x1, _x10) {
    return _ref6.apply(this, arguments);
  };
}();
var handleUpdateAddress = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7(req, res) {
    var addressId, data, _t7;
    return _regenerator().w(function (_context7) {
      while (1) switch (_context7.p = _context7.n) {
        case 0:
          ...
          _context7.n = 1;
          return _userAPIService["default"].updateAddress(addressId, req.body);
        case 1:
          data = _context7.v;
  ...
  return function handleUpdateAddress(_x11, _x12) {
    return _ref7.apply(this, arguments);
  };
}();
var handleDeleteAddress = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8(req, res) {
    var addressId, data, _t8;
    return _regenerator().w(function (_context8) {
      while (1) switch (_context8.p = _context8.n) {
        case 0:
          ...
          addressId = req.params.addressId;
          _context8.n = 1;
          return _userAPIService["default"].deleteAddress(addressId);
        case 1:
          data = _context8.v;
  ...
  return function handleDeleteAddress(_x13, _x14) {
...
module.exports = {
  ...
  handleGetUserAddresses: handleGetUserAddresses,
