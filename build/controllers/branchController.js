...
var _branchAPIService = _interopRequireDefault(require("../services/branchAPIService"));
...
var handleGetAllBranches = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return _branchAPIService["default"].getAllBranches();
        case 1:
          data = _context.v;
  ...
  return function handleGetAllBranches(_x, _x2) {
