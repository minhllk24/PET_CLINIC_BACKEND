...
var _cartAPIService = _interopRequireDefault(require("../services/cartAPIService"));
...
var handleGetCart = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          _context.n = 1;
          return _cartAPIService["default"].getCartByUserId(userId);
        case 1:
          data = _context.v;
  ...
  return function handleGetCart(_x, _x2) {
...
var handleAddToCart = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          ...
          userId = req.user.user_id;
          _context2.n = 1;
          return _cartAPIService["default"].addToCart(userId, req.body);
        case 1:
          data = _context2.v;
  ...
  return function handleAddToCart(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var handleUpdateCartItem = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(req, res) {
    var userId, itemId, data, _t3;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          ...
          _context3.n = 1;
          return _cartAPIService["default"].updateCartItem(userId, itemId, req.body);
        case 1:
          data = _context3.v;
  ...
  return function handleUpdateCartItem(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var handleDeleteCartItem = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(req, res) {
    var userId, itemId, data, _t4;
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        case 0:
          ...
          itemId = req.params.item_id;
          _context4.n = 1;
          return _cartAPIService["default"].deleteCartItem(userId, itemId);
        case 1:
          data = _context4.v;
  ...
  return function handleDeleteCartItem(_x7, _x8) {
