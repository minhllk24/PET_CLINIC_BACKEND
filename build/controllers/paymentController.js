...
var _paymentAPIService = _interopRequireDefault(require("../services/paymentAPIService"));
...
var handleGetPayments = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return _paymentAPIService["default"].getAllPayments(req.query);
        case 1:
          data = _context.v;
  ...
  return function handleGetPayments(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var handleUpdatePaymentStatus = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(req, res) {
    var id, status, data, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          ...
          _context2.n = 1;
          return _paymentAPIService["default"].updatePaymentStatus(id, status);
        case 1:
          data = _context2.v;
  ...
  return function handleUpdatePaymentStatus(_x3, _x4) {
