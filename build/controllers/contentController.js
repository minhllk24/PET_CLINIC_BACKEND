...
var _contentAPIService = _interopRequireDefault(require("../services/contentAPIService"));
...
var handleGetPosts = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return _contentAPIService["default"].getPosts(req.query);
        case 1:
          data = _context.v;
  ...
  return function handleGetPosts(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var handleGetPostBySlug = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          _context2.p = 0;
          _context2.n = 1;
          return _contentAPIService["default"].getPostBySlug(req.params.slug);
        case 1:
          data = _context2.v;
  ...
  return function handleGetPostBySlug(_x3, _x4) {
...
var handleCreatePost = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          _context3.p = 0;
          _context3.n = 1;
          return _contentAPIService["default"].createPost(req.user, req.body);
        case 1:
          data = _context3.v;
  ...
  return function handleCreatePost(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var handleGetFirstAidGuides = /*#__PURE__*/function () {
  ...
  return function handleGetFirstAidGuides(_x7, _x8) {
