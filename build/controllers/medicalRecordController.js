...
var _medicalRecordAPIService = _interopRequireDefault(require("../services/medicalRecordAPIService"));
...
var handleGetRecordsByPet = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          _context.n = 1;
          return _medicalRecordAPIService["default"].getRecordsByPet(petId, req.user);
        case 1:
          data = _context.v;
  ...
  return function handleGetRecordsByPet(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var handleGetDetailRecord = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          ...
          id = req.params.id;
          _context2.n = 1;
          return _medicalRecordAPIService["default"].getRecordById(id, req.user);
        case 1:
          data = _context2.v;
  ...
  return function handleGetDetailRecord(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var handleCreateRecord = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(req, res) {
    var payload, data, _t3;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          ...
          _context3.n = 1;
          return _medicalRecordAPIService["default"].createRecord(payload, req.user);
        case 1:
          data = _context3.v;
  ...
  return function handleCreateRecord(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var handleUpdateRecord = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(req, res) {
    var id, payload, data, _t4;
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        case 0:
          ...
          _context4.n = 1;
          return _medicalRecordAPIService["default"].updateRecord(id, payload, req.user);
        case 1:
          data = _context4.v;
  ...
  return function handleUpdateRecord(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var handleDeleteRecord = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.p = _context5.n) {
        case 0:
          ...
          id = req.params.id;
          _context5.n = 1;
          return _medicalRecordAPIService["default"].deleteRecord(id, req.user);
        case 1:
          data = _context5.v;
  ...
  return function handleDeleteRecord(_x9, _x0) {
    return _ref5.apply(this, arguments);
  };
}();
module.exports = {
  handleGetRecordsByPet: handleGetRecordsByPet,
  handleGetDetailRecord: handleGetDetailRecord,
