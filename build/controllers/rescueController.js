...
var _rescueAPIService = _interopRequireDefault(require("../services/rescueAPIService"));
...
var handleGetStations = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return _rescueAPIService["default"].getStations();
        case 1:
          data = _context.v;
  ...
  return function handleGetStations(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var handleGetRescuePosts = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          _context2.p = 0;
          _context2.n = 1;
          return _rescueAPIService["default"].getRescuePosts();
        case 1:
          data = _context2.v;
  ...
  return function handleGetRescuePosts(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var handleGetAdoptionPets = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          _context3.p = 0;
          _context3.n = 1;
          return _rescueAPIService["default"].getAdoptionPets();
        case 1:
          data = _context3.v;
  ...
  return function handleGetAdoptionPets(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var handleCreateAdoptionRequest = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        case 0:
          ...
          _context4.n = 1;
          return _rescueAPIService["default"].createAdoptionRequest(userId, req.body);
        case 1:
          data = _context4.v;
  ...
  return function handleCreateAdoptionRequest(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var handleGetMyRequests = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.p = _context5.n) {
        case 0:
          ...
          userId = req.user.user_id;
          _context5.n = 1;
          return _rescueAPIService["default"].getMyAdoptionRequests(userId);
        case 1:
          data = _context5.v;
  ...
  return function handleGetMyRequests(_x9, _x0) {
    return _ref5.apply(this, arguments);
  };
}();
var handleUpdateStatus = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(req, res) {
    var id, status, data, _t6;
    return _regenerator().w(function (_context6) {
      while (1) switch (_context6.p = _context6.n) {
        case 0:
          ...
          _context6.n = 1;
          return _rescueAPIService["default"].updateAdoptionRequestStatus(id, status);
        case 1:
          data = _context6.v;
...
module.exports = {
  ...
  handleGetRescuePosts: handleGetRescuePosts,
  handleGetAdoptionPets: handleGetAdoptionPets,
  handleCreateAdoptionRequest: handleCreateAdoptionRequest,
  handleGetMyRequests: handleGetMyRequests,
